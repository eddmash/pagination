...
This is inspired by `Php Faker <https://github.com/fzaninotto/Faker>`_ which is also inspired by
`Ruby Faker <https://rubygems.org/gems/faker>`_ . A whole lot of inspiring going on there.
...
for that particular editText. All this is made possible by :doc:`Providers <faker_providers>`
