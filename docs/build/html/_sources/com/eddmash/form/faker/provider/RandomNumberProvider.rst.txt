...
.. java:constructor:: public RandomNumberProvider(PopulatorInterface populator)
   :outertype: RandomNumberProvider

RandomNumberProvider
^^^^^^^^^^^^^^^^^^^^

.. java:constructor:: public RandomNumberProvider(PopulatorInterface populator, String format)
   :outertype: RandomNumberProvider
